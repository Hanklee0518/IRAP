...
namespace IRAP.WCF.Client.Method
{
    public class IRAPMESClient
    {
        ...
        public void mfn_GetList_OpenPWOsOfALine(
            int communityID,
            int resourceTreeID,
            int leafID,
            long sysLogID,
            ...
            out string errText)
        {
            ...
            try
            {
                ...
                WriteLog.Instance.Write(
                    string.Format(
                        "调用 mfn_GetList_OpenPWOsOfALine 函数， " +
                        "参数：CommunityID={0}|ResourceTreeID={1}|" +
        ...
        /// </summary>
        /// <param name="communityID">社区标识</param>
        public void ufn_GetList_OpenPWOs(
            int communityID,
            ref List<OpenPWOInfo> datas,
            out int errCode,
            out string errText)
        {
            string strProcedureName =
        ...
        /// <returns></returns>
        public void mfn_GetInfo_OpenPWOs(
            int communityID,
            string moNumber,
            int moLineNo,
            ref List<OpenPWOInfo> datas,
            ...
            out string errText)
        {
            ...
            try
            {
                ...
                WriteLog.Instance.Write(
                    string.Format(
                        "调用 mfn_GetList_OpenPWOs 函数， " +
                        "参数：CommunityID={0}|MONumber={1}|"+
                        "MOLineNo={2}",
        ...
        /// <param name="errCode"></param>
        /// <param name="errText"></param>
        public void usp_SaveFact_BatchProductionEnd_N(
            int communityID,
            int t216LeafID,
            int t107LeafID,
            string batchNumber,
            ...
            out string errText)
        {
            ...
            try
            {
                ...
                WriteLog.Instance.Write(
                    string.Format(
                        "执行存储过程 usp_SaveFact_BatchProductionEnd_N，输入参数：" +
                        "CommunityID={0}|T216LeafID={1}|T107LeafID={2}|" +
                        "BatchNumber={3}|SysLogID={4}",
                        communityID, t216LeafID, t107LeafID, batchNumber, sysLogID),
                    strProcedureName);
                ...
                using (WCFClient client = new WCFClient())
                {
                    object rlt = client.WCFRESTFul(
                        "IRAP.BL.MES.dll",
                        "IRAP.BL.MES.WorkOrder",
                        "usp_SaveFact_BatchProductionEnd_N",
                        hashParams,
                        out errCode,
                        out errText);
                    WriteLog.Instance.Write(
        ...
        public void ufn_GetList_BatchByEquipment_N(
            int communityID,
            int t133LeafID,
            int t107LeafID,
            string opType,
            ...
            out string errText)
        {
            ...
            try
            {
                ...
                WriteLog.Instance.Write(
                    string.Format(
                        "调用 ufn_GetList_BatchByEquipment_N 函数， " +
                        "参数：CommunityID={0}|T133LeafID={1}"+
                        "|T107LeafID={2}|OpType={3}|SysLogID={4}",
                        communityID,
                        t133LeafID,
                        t107LeafID,
                        opType,
                ...
                using (WCFClient client = new WCFClient())
                {
                    ...
                    object rlt =
                        client.WCFRESTFul(
                            "IRAP.BL.MES.dll",
                            "IRAP.BL.MES.WorkOrder",
                            "ufn_GetList_BatchByEquipment_N",
                        hashParams,
                        out errCode,
                        out errText);
                    WriteLog.Instance.Write(
        ...
        /// <param name="errCode"></param>
        /// <param name="errText"></param>
        public void ufn_GetList_WorkUnitBatchPWONo(
            int communityID,
            int t107LeafID,
            string batchNumber,
            long sysLogID,
            ...
            out string errText)
        {
            ...
            try
            {
                ...
                WriteLog.Instance.Write(
                    string.Format(
                        "调用 ufn_GetList_WorkUnitBatchPWONo 函数， " +
                        "参数：CommunityID={0}|T107LeafID={1}|"+
                        "BatchNumber={2}|SysLogID={3}",
                        communityID,
                        t107LeafID,
                        batchNumber,
                        sysLogID),
                ...
                using (WCFClient client = new WCFClient())
                {
                    ...
                    object rlt =
                        client.WCFRESTFul(
                            "IRAP.BL.MES.dll",
                            "IRAP.BL.MES.WorkOrder",
                            "ufn_GetList_WorkUnitBatchPWONo",
                        hashParams,
                        out errCode,
                        out errText);
                    WriteLog.Instance.Write(
        ...
        /// <param name="errText"></param>
        /// <returns></returns>
        public void usp_SaveFact_BatchBreakProduction(
            int communityID,
            int t216LeafID,
            int t107LeafID,
            string batchNumber,
            ...
            try
            {
                ...
                using (WCFClient client = new WCFClient())
                {
                    object rlt = client.WCFRESTFul(
                        ...
                        "usp_SaveFact_BatchBreakProduction",
                        hashParams,
                        out errCode,
                        out errText);
                    WriteLog.Instance.Write(
