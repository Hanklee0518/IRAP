...
namespace IRAP.Entity.Kanban
{
    ...
    public class LeafSetEx_ComparerByCode : IComparer<LeafSetEx>
    {
        public int Compare(LeafSetEx x, LeafSetEx y)
        {
            if (x == null)
    ...
    public class LeafSetEx_ComparerByName : IComparer<LeafSetEx>
    {
        public int Compare(LeafSetEx x, LeafSetEx y)
        {
            if (x == null)
            ...
            else
            {
                ...
                {
                    return x.LeafName.CompareTo(y.LeafName);
                }
            }
        }
    }
